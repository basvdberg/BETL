...
USING (VALUES
 ...
 ,(25,N'_source',N'name of source system',999,900,N'varchar',10,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)
 ,(30,N'_transfer_id',N'transfer_id ( logging and lineage) ',999,910,N'int',NULL,NULL,0,NULL,1,1,1,1,1,NULL,NULL)
 ,(50,N'_exp_dt',N'expiration timestamp',999,920,N'datetime',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)
 ,(70,N'_batch_id',N'batch_id ( parent of transfer_id, orchestration). ',999,930,N'int',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)
 ,(90,N'_is_current',N'this record is the latest record in transaction time  (_eff_dt)',999,940,N'bit',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,'2019-12-11T09:56:35.373',N'')
 ,(100,N'_mutation_dt',N'timestamp of record mutation via update sql',999,950,N'datetime',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,'2019-12-11T09:57:32.423',N'')
 ,(110,N'_mutation_user',N'user name of record mutation via update sql',999,960,N'sysname',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,'2019-12-11T09:58:23.873',N'')
 ,(120,N'_chksum',N'a checksum used for change data capture',999,970,N'varchar',255,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,'2019-12-11T10:20:40.157',N'')
 ,(1000,N'_record_dt',N'timestamp of record creation (via default) or timestamp of record update ( via update sql). ',999,980,N'datetime',NULL,N'(getdate())',0,NULL,1,1,1,1,1,NULL,NULL)
 ,(1010,N'_record_user',N'user name of record creation (via default) or user name of record update ( via update sql). ',999,990,N'sysname',NULL,N'(suser_sname())',0,NULL,1,1,1,1,1,NULL,NULL)
 ,(1100,N'{{obj_name}}_sid',N'surrogate id ( unique id generated by this dwh, not from source)',200,-900,N'int',NULL,NULL,0,N'DESC',0,1,1,1,0,'2020-06-18T14:00:03.747',N'')
